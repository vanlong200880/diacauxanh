...
// custom
add_action( 'woocommerce_single_product_page_summary', 'woocommerce_template_single_title', 5 );
add_action( 'woocommerce_single_product_page_summary', 'woocommerce_template_single_meta', 10 );
add_action( 'woocommerce_single_product_page_summary', 'woocommerce_template_single_excerpt', 15 );
//add_action( 'woocommerce_single_product_page_summary', 'woocommerce_template_single_sharing', 50 );

add_action( 'woocommerce_single_product_page_detail', 'woocommerce_template_single_meta', 5 );
/**
 * Reviews
 *
...
add_action( 'woocommerce_after_shop_paging', 'woocommerce_pagination', 10 );
