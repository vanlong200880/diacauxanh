...
if ( ! class_exists( 'Storefront' ) ) :
	...
	class Storefront {
      ...
      wp_enqueue_style( 'storefront-style-bootstrap', get_template_directory_uri() . '/assets/css/bootstrap.min.css', '', $storefront_version );
      wp_enqueue_style( 'storefront-style-main', get_template_directory_uri() . '/assets/css/main.css', '', $storefront_version );
